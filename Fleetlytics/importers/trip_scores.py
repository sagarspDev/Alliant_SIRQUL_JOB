...
class TripScoreImporter:
    """Import the generated trip-score SQL file."""

    def run(self, sql_path: Path, *, dry_run: bool) -> ImportResult:
        """Import one trip-score SQL file and return the execution summary."""
...
def import_trip_scores(sql_path: Path, *, dry_run: bool) -> ImportResult:
    """Import the generated trip-score SQL file."""

    importer = TripScoreImporter()
